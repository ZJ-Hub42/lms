				...
				<div class="sidebar-menu">
	                ...
	                <ul>
                        ...
                        <li class="menu menu-toggle1">
      						<a href="#"><i class="fas fa-id-card"></i>My profil <span class="fa fa-chevron-down"></span></a>
                            <ul class="menus1">
                                <li><a href="changepass.php">tukar kata laluan</a></li>
                                <li><a href="profile.php">profil</a></li>
                            </ul>
	   					</li>
    					<li class="menu <?php if($page=='ibook'){ echo 'active';} ?>">
      						<a href="my-issued-books.php"><i class="fas fa-book"></i>senarai pinjaman</a>
    					</li>
    					<li class="menu <?php if($page=='books'){ echo 'active';} ?>">
      						<a href="books.php"><i class="fas fa-book"></i>buku</a>
    					</li>	       	                    
    					<li class="menu <?php if($page=='rbook'){ echo 'active';} ?>">
      						<a href="request-book.php"><i class="fas fa-book"></i>mohon buku baru</a>
    					</li>	                    
    				</ul>
				</div>
			</div>
						...
						<ul>
							...
							<li class="dropdown">
								<?php
                                     $res = mysqli_query($link, "select * from t_registration where username='".$_SESSION['teacher']."'");
                                     while ($row = mysqli_fetch_array($res)){
                                         ?><a href="" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo $row["photo"]; ?>" alt=""><span><?php echo $_SESSION["teacher"]; ?></span></a> <?php
                                     }
                                ?>
								<ul class="dropdown-menu">
									<li class="user-header text-center">
                                        ...
                                        ?>
										<p><?php echo $_SESSION["teacher"]; ?> - Teacher</p>
									</li>
