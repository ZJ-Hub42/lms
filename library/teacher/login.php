	...
	<div class="login registration">
		<div class="wrapper">
			<div class="reg-header text-center">
				<h2>KV Library Management System</h2>
				<div class="gap-40"></div>
			</div>
			<div class="gap-30"></div>
			<div class="login-content">
				<div class="login-body">
                    <h4>Guru Login Form</h4>
					<form action="" method="post">
						...
						<div class="mb-20">
							<input class="btn btn-info submit" type="submit" name="login" value="Login"><a class="reset_pass" href="lost-password.php"></a>
						</div>
					</form>
				</div>
				<div class="login-footer text-center">
					<div class="separator">
		                <p class="change_link">Masukkan username & password seperti yang didaftarkan
		                </p>
	                </div>
				</div>
                 <?php 
