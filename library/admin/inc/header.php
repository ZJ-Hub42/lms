...
<head>
	<meta charset="UTF-8">
	<title>KV Library Management System</title>
				  ...
				  <div class="border"></div>
	                <ul>
	                    ...
	                    <li class="menu <?php if($page=='sinfo'){ echo 'active';} ?>">
      						<a href="all-student-info.php"><i class="fas fa-desktop"></i>Info Pelajar</a>
    					</li>
    					<li class="menu <?php if($page=='tinfo'){ echo 'active';} ?>">
      						<a href="all-teacher-info.php"><i class="fas fa-desktop"></i>Info Guru</a>
    					</li>
                        			<li class="menu menu-toggle3">
      						<a href="#"><i class="fas fa-users"></i>Pengurusan Pengguna <span class="fa fa-chevron-down"></span></a>
      						<ul class="menus3">
      							<li><a href="add-student.php">Tambah pelajar </a></li>
      							<li><a href="add-teacher.php">Tambah guru</a></li>
    					
      						</ul>
    					</li>
                        <li class="menu menu-toggle2">
      						<a href="#"><i class="fas fa-location-arrow"></i>pengurusan buku <span class="fa fa-chevron-down"></span></a>
      						<ul class="menus2">
      							<li><a href="add-book.php">tambah buku</a></li>
      							<li><a href="display-delete-books.php">Padam buku</a></li>
	                   
      						</ul>
    					</li>
                        <li class="menu menu-toggle1">
      						<a href="#"><i class="fas fa-list-alt"></i>pinjaman buku <span class="fa fa-chevron-down"></span></a>
      						<ul class="menus1">
      							<li><a href="student-issue-book.php">pinjaman pelajar</a></li>
      							<li><a href="teacher-issue-book.php">pinjaman guru</a></li>
    		
      						</ul>
    					</li>
    					 
    					<li class="menu <?php if($page=='rbook'){ echo 'active';} ?>">
   						<a href="requested-books.php"><i class="fas fa-book"></i>permohon buku baru</a></li>
	                </ul>
    					</li>
    				</ul>
				</div>
			...
			<div class="content">
				<div class="inner">
					<div class="heading text-center">
						<h3>KV Library Control Panel</h3>
					</div>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li class="user-header text-center">
                                        ...
                                        ?>
										<p><?php echo $_SESSION["username"]; ?> - Library</p>
									</li>
