				...
				<div class="row counterup">
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box">
							...
							<div class="text">
								...
								<h4><a href="members.php">Ahli</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box2">
							...
							<div class="text">
								...
								<h4><a href="issued-books.php">Peminjam Buku</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box3">
							...
							<div class="text">
								...
								<h4><a href="display-books.php">Senarai Buku</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box">
							...
							<div class="text">
								<h4 class="mt-20"><a href="status.php">Status Pengguna</a></h4>
							</div>
						</div>
					</div>
